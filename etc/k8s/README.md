...
Necessary helm charts are created under `etc/k8s/demomicroservice` folder. Based on your back-office application UI, remove the other UI charts. Ex, if you are using **angular** UI, remove **web**, **blazor** and **blazor-server** charts.
...
````powershell
127.0.0.1 blazor.demomicroservice.dev
127.0.0.1 demomicroservice.dev
127.0.0.1 authserver.demomicroservice.dev
127.0.0.1 identity.demomicroservice.dev
127.0.0.1 administration.demomicroservice.dev
127.0.0.1 product.demomicroservice.dev
127.0.0.1 saas.demomicroservice.dev
127.0.0.1 gateway-web.demomicroservice.dev
127.0.0.1 gateway-public.demomicroservice.dev
````
...
* Run `deploy-staging.ps1` in the `helm-chart` directory. It is deployed with the `demomicroservice` namespace.

* *You may wait ~30 seconds on first run for preparing the database*.

* Browse https://demomicroservice-st-public-web for public and
   https://demomicroservice-st-blazor for the back-office application
