...
using DemoMicroService.Shared.Hosting.Microservices.DbMigrations;
using Volo.Abp.Data;
...
public class BankCashServiceDatabaseMigrationEventHandler
    : DatabaseMigrationEventHandlerBase<BankCashServiceDbContext>,
        IDistributedEventHandler<TenantCreatedEto>,
        IDistributedEventHandler<TenantConnectionStringUpdatedEto>,
        IDistributedEventHandler<ApplyDatabaseMigrationsEto>
{
    public BankCashServiceDatabaseMigrationEventHandler(
