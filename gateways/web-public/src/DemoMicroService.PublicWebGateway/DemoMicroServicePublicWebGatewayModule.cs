...
using DemoMicroService.Shared.Hosting.Gateways;
using Swashbuckle.AspNetCore.SwaggerUI;
using Volo.Abp;
using Volo.Abp.Modularity;
using Yarp.ReverseProxy.Configuration;

namespace DemoMicroService.PublicWebGateway;

[DependsOn(
    typeof(DemoMicroServiceSharedHostingGatewaysModule)
)]
public class DemoMicroServicePublicWebGatewayModule : AbpModule
{
